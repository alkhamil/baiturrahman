...
class Jamaah_model extends CI_Model {
    ...
    public $table = 'm_jamaah';
    public $primary_key = 'm_jamaah.id';
    public $order_by = 'm_jamaah.id';
    public $order_type = 'DESC';
    public $search_field = 'm_jamaah.name';
    public $column_order = ['m_jamaah.name']; //set column field database for datatable orderable
    public $column_search = ['m_jamaah.name']; //set column field database for datatable searchable 
