...
class About_model extends CI_Model {
    ...
    public $primary_key = 'm_about.id';
    public $order_by = 'm_about.id';
    public $order_type = 'ASC';
    public $search_field = 'm_about.name';
    public $column_order = ['m_about.name']; //set column field database for datatable orderable
    public $column_search = ['m_about.name']; //set column field database for datatable searchable 
