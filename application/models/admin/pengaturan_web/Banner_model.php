...
class Banner_model extends CI_Model {
    ...
    public $search_field = 'm_banner.title';
    public $column_order = ['m_banner.title']; //set column field database for datatable orderable
    public $column_search = ['m_banner.title']; //set column field database for datatable searchable 
