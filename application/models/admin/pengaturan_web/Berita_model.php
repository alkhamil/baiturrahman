...
class Berita_model extends CI_Model {
    ...
    public $primary_key = 'm_berita.id';
    public $order_by = 'm_berita.id';
    public $order_type = 'ASC';
    public $search_field = 'm_berita.name';
    public $column_order = ['m_berita.name']; //set column field database for datatable orderable
    public $column_search = ['m_berita.name']; //set column field database for datatable searchable 
