...
class Kegiatan_model extends CI_Model {
    ...
    public $primary_key = 'm_kegiatan.id';
    public $order_by = 'm_kegiatan.id';
    public $order_type = 'ASC';
    public $search_field = 'm_kegiatan.name';
    public $column_order = ['m_kegiatan.name']; //set column field database for datatable orderable
    public $column_search = ['m_kegiatan.name']; //set column field database for datatable searchable 
