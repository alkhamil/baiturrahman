...
class Pengurus_model extends CI_Model {
    ...
    public $table = 'm_pengurus';
    public $primary_key = 'm_pengurus.id';
    public $order_by = 'm_pengurus.id';
    public $order_type = 'DESC';
    public $search_field = 'm_pengurus.name';
    public $column_order = ['m_pengurus.name']; //set column field database for datatable orderable
    public $column_search = ['m_pengurus.name']; //set column field database for datatable searchable 
