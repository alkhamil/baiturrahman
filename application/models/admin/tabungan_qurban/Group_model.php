...
class Group_model extends CI_Model {
    ...
    public $table = 'm_jamaah_group';
    public $primary_key = 'm_jamaah_group.id';
    public $order_by = 'm_jamaah_group.id';
    public $order_type = 'DESC';
    public $search_field = 'm_jamaah_group.name';
    public $column_order = ['m_jamaah_group.name']; //set column field database for datatable orderable
    public $column_search = ['m_jamaah_group.name']; //set column field database for datatable searchable 
