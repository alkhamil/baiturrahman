...
class Tabungan_detail_model extends CI_Model {

    public $table = 't_tabungan_detail';
    public $primary_key = 't_tabungan_detail.id';
    public $order_by = 't_tabungan_detail.id';
    public $order_type = 'ASC';
    public $search_field = 't_tabungan_detail.amount';
    public $column_order = ['t_tabungan_detail.amount']; //set column field database for datatable orderable
    public $column_search = ['t_tabungan_detail.amount']; //set column field database for datatable searchable 
    ...
    function lists($select = '*', $where = null, $limit = 10 ,$offset = 0)
    {
        $this->db->select($select)
                 ->join('t_tabungan', 't_tabungan.id = t_tabungan_detail.tabungan_id', 'left')
                 ->limit($limit,$offset);
    ...
    function list_count($where = null, $is_where = false) {
        $this->db->join('t_tabungan', 't_tabungan.id = t_tabungan_detail.tabungan_id', 'left');
