...
class Tabungan_model extends CI_Model {
    ...
    public $table = 't_tabungan';
    public $primary_key = 't_tabungan.id';
    ...
    function lists($select = '*', $where = null, $limit = 10 ,$offset = 0)
    {
        $this->db->select($select)
                 ->join('m_jamaah_group', 'm_jamaah_group.id = t_tabungan.jamaah_group_id', 'left')
                 ->join('m_hewan', 'm_hewan.id = t_tabungan.hewan_id', 'left')
    ...
    function list_count($where = null, $is_where = false) {
        $this->db->join('m_jamaah_group', 'm_jamaah_group.id = t_tabungan.jamaah_group_id', 'left')
            ->join('m_hewan', 'm_hewan.id = t_tabungan.hewan_id', 'left')
            ->join('m_hewan_jenis', 'm_hewan_jenis.id = m_hewan.hewan_jenis_id', 'left')
            ->join('m_hewan_golongan', 'm_hewan_golongan.id = m_hewan.hewan_golongan_id', 'left');
