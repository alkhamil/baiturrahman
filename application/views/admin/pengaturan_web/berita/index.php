        ...
        <div class="accordion" id="accordionForm">
            <div class="card">
                ...
                <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionForm">
                    <div class="card-body">
                        <form action="<?= $simpan ?>" method="POST" id="form-berita" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <img class="profile-pic img-thumbnail" src="<?= base_url('assets/uploads/dft.png') ?>" style="width: 300px; height:180px;">
                                    </div>
                                    <div class="form-group">
                                        <label for="name" class="label-required">Judul Berita</label>
                                        <input type="text" class="form-control form-required" name="name" id="name" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="desc" class="label-required">Isi</label>
                                        <textarea name="desc" id="desc" class="form-control" cols="10" rows="5" required></textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <hr>
    ...
    $(document).on("click.ev", ".btn-edit", function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                form.find('[name=posted_date]').val(dt.posted_date);
