        ...
        <div class="accordion" id="accordionExample">
            <div class="card">
                ...
                <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                    <div class="card-body">
                        <form action="<?= $simpan ?>" method="POST" id="form-kegiatan">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="icon" class="label-required">Icon</label>
                                        <input type="text" class="form-control form-required" name="icon" id="icon" required>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
    ...
    $(document).on("click.ev", ".btn-edit", function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                let dt = data.kegiatan;
                hideLoad();
                scrollUp('#form-kegiatan');
                ...
                form.find('[name=icon]').val(dt.icon);
